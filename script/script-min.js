    ...
    if (console.log(e), "" != e) switch (e) {
      ...
      default:
        if (~e.indexOf("#audio") && ~e.indexOf("/")) {
            var i = e.split("/")[1];
            console.log(i), console.log(i), setSongPlaying(i);
        }
    }
}
...
$(document).ready(function() {
    ...
    $(".multimedia-main video").each(function() {
        ...
        0), s = i.find(".v-distance-full"), r = i.find(".v-distance-indicator"), l = $(".v-player-main").find(".v-buttons"), t = i.find(".v-info-time");
        addTimeSpans(t);
